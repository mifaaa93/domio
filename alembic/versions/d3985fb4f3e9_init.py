...
Revision ID: d3985fb4f3e9
Revises: 
Create Date: 2025-11-06 15:36:26.365924
...
def upgrade() -> None:
    ...
    sa.Column('recurring_on', sa.Boolean(), server_default=sa.text('false'), nullable=False),
